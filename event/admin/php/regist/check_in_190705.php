...
$day_query="SELECT * FROM agenda_tbl WHERE code='".$code."' and eventdate<".time()." and eventdate>".(time()-86400);
...
*/
			...
			$json = array('name'=>$name, 'office'=>$office,'in_time' => date("Y.m.d H시i분",$timer),'out_time' => "");
			mysqli_query($conn, $query_in);
