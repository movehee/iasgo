...
<div style="position:absolute;top:<?=$ppp*100?>%;width:100%;height:100%;page-break-before: always;" width="100%" height="100%">
	<div style="position:absolute;left:0px;top:150px;width:510px">
		...
		<div style="font-family:ftlight; font-size:<?=$office_size?>px;padding-top:50px;color:#000000;text-align:center;"><b><?=$office?></b>
		</div>

		
	</div>

	<div style="position:absolute;left:510px;top:150px;width:510px">
	...
	<div style="position:absolute;left:0px;top:752px;width:510px">
		<div style="font-size:<?=$bfs?>px;color:#000000;letter-spacing:0px;padding-left:120px;padding-top:85px;"><?=$name?></div>
	...
	<div style="position:absolute;left:510px;top:752px;width:510px">
		<div style="font-size:<?=$bfs?>px;color:#000000;letter-spacing:0px;padding-left:150px;padding-top:85px;"><?=$name?></div>
