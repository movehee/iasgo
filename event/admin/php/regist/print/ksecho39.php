...
<div style="position:absolute;top:<?=$ppp*100?>%" width="100%" height="100%">
	<div style="position:absolute;left:348px;top:270px;width:500px">
		...
		<div style="position:relative;top:80px;left:140px;width:200px;font-weight:bold;">
	...
	<div style="position:relative;color:#000000;top:23px;left:300px;font-size=15px;font-weight:bold;NanumBarunGothic;">2019.09.21</div>
		<div style="position:relative;color:#000000;top:104px;font-size=20px;font-weight:bold;NanumBarunGothic;"><?=$name?></div>
		<div style="position:relative;color:#000000;top:128px;font-size=20px;font-weight:bold;NanumBarunGothic;">
		<?=getConvertNumberToKorean($price)?>
		&nbsp;</div>
	...
	<div style="position:relative;color:#000000;left:360px;font-size=15px;font-weight:bold;NanumBarunGothic;">2019.09.21</div>
		...
		<div style="position:relative;color:#000000;top:166px;left:95px;font-size=14px;font-weight:bold;NanumBarunGothic;">39</div>
	</div>
</div>
