							...
							<?	
								...
								<tr>
									...
									if($info2_type>1000){
										...
										$temp_query = "SELECT sum(b.info) sum FROM regist_tbl a, regist_type_sub_tbl b WHERE a.info".$info2."=b.sid and a.code='".$code."' and a.del='N' and a.pay_chk='Y' and a.pay_date<".$event_time;
										$temp_result = mysqli_query($conn, $temp_query);
										$temp_d = mysqli_fetch_array($temp_result);
										...
										$temp_query = "select sum(info".$info2.") sum from regist_tbl where code='".$code."' and del='N' and pay_chk='Y' and pay_date<".$event_time;
										$temp_result = mysqli_query($conn, $temp_query);
										$temp_d = mysqli_fetch_array($temp_result);
									...
									<?
										if($info2_type>1000){
											...
											$temp_query = "SELECT sum(b.info) sum FROM regist_tbl a, regist_type_sub_tbl b WHERE a.info".$info2."=b.sid and a.code='".$code."' and a.del='N' and a.pay_chk='Y' and a.pay_date>".$tab_col['eventdate']." and a.pay_date<".($tab_col['eventdate']+86400);
											$temp_result = mysqli_query($conn, $temp_query);
											$temp_d = mysqli_fetch_array($temp_result);

											
										}else{
											$temp_query = "select sum(info".$info2.") sum from regist_tbl where code='".$code."' and del='N' and pay_chk='Y' and pay_date>".$tab_col['eventdate']." and pay_date<".($tab_col['eventdate']+86400);
											$temp_result = mysqli_query($conn, $temp_query);
											$temp_d = mysqli_fetch_array($temp_result);
										}
										$temp_sum2 += $temp_d['sum'];
