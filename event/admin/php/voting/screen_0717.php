	...
	<div class="fullScreen">
		...
		<div class="answer">
			...
			<dl class="option <?if(mb_strlen($d['answer1'], 'utf-8')>50){?>ss<?}else if(mb_strlen($d['answer1'], 'utf-8')>25){?> s<?}?>">
				...
				<dt <?if($d['status']==2 && $d['correct']=="1"){?>style='color:#12a3df'<?}?> class="fSize<?if(mb_strlen($d['answer1'], 'utf-8')>50){?>_ss<?}else if(mb_strlen($d['answer1'], 'utf-8')>25){?>_s<?}?>">① <?=$d['answer1']?></dt>
				<dd>
			...
			<dl class="option <?if(mb_strlen($d['answer2'], 'utf-8')>50){?>ss<?}else if(mb_strlen($d['answer2'], 'utf-8')>25){?> s<?}?>">
				...
				<dt <?if($d['status']==2 && $d['correct']=="2"){?>style='color:#12a3df'<?}?> class="fSize<?if(mb_strlen($d['answer2'], 'utf-8')>50){?>_ss<?}else if(mb_strlen($d['answer2'], 'utf-8')>25){?>_s<?}?>">② <?=$d['answer2']?></dt>
			...
			<dl class="option <?if(mb_strlen($d['answer3'], 'utf-8')>50){?>ss<?}else if(mb_strlen($d['answer3'], 'utf-8')>25){?> s<?}?>">
				...
				<dt <?if($d['status']==2 && $d['correct']=="3"){?>style='color:#12a3df'<?}?> class="fSize<?if(mb_strlen($d['answer3'], 'utf-8')>50){?>_ss<?}else if(mb_strlen($d['answer3'], 'utf-8')>25){?>_s<?}?>">③ <?=$d['answer3']?></dt>
				<dd>
			...
			<dl class="option <?if(mb_strlen($d['answer4'], 'utf-8')>50){?>ss<?}else if(mb_strlen($d['answer4'], 'utf-8')>25){?> s<?}?>">
				...
				<dt <?if($d['status']==2 && $d['correct']=="4"){?>style='color:#12a3df'<?}?> class="fSize<?if(mb_strlen($d['answer4'], 'utf-8')>50){?>_ss<?}else if(mb_strlen($d['answer4'], 'utf-8')>25){?>_s<?}?>">④ <?=$d['answer4']?></dt>
			...
			<dl class="option <?if(mb_strlen($d['answer5'], 'utf-8')>50){?>ss<?}else if(mb_strlen($d['answer5'], 'utf-8')>25){?> s<?}?>">
				...
				<dt <?if($d['status']==2 && $d['correct']=="5"){?>style='color:#12a3df'<?}?> class="fSize<?if(mb_strlen($d['answer5'], 'utf-8')>50){?>_ss<?}else if(mb_strlen($d['answer5'], 'utf-8')>25){?>_s<?}?>">⑤ <?=$d['answer5']?></dt>
			...
			<dl class="option <?if(mb_strlen($d['answer6'], 'utf-8')>50){?>ss<?}else if(mb_strlen($d['answer6'], 'utf-8')>25){?> s<?}?>">
				...
				<dt <?if($d['status']==2 && $d['correct']=="6"){?>style='color:#12a3df'<?}?> class="fSize<?if(mb_strlen($d['answer6'], 'utf-8')>50){?>_ss<?}else if(mb_strlen($d['answer6'], 'utf-8')>25){?>_s<?}?>">⑥ <?=$d['answer6']?></dt>
