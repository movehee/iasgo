    ...
    function html5Upload() {	
    	...
    	sUploadURL= 'http://'+window.location.hostname+'/func/naver_editor/quick_photo_uploader/popup/FileUploader_html5.php'; 	//upload URL
    	//파일을 하나씩 보내고, 결과를 받음.
...
*/
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : 'http://'+window.location.hostname+'/func/naver_editor/quick_photo_uploader/popup/FileUploader.php',	//샘플 URL입니다.
