<xsl:stylesheet version="1.0"
	...
	<xsl:template match="article-meta | front-stub" mode="metadata">
		...
		<div class="sec">
	  		...
	  		<div class="fm-sec">
			  	<xsl:apply-templates select="permissions | issue-id | issue-title | issue-sponsor | issue-part | isbn | supplement | self-uri | related-article | funding-group | conference | counts | custom-meta-group" mode="metadata" />
		  	</div>  	
	  	</div>
