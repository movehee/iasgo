...
<!-- To reduce dependency on a DTD for processing, we declare
  ...
  <xsl:key name="fig-by-id" match="fig" use="@id"/>
  <xsl:key name="table-by-id" match="table" use="@id"/>

  <xsl:key name="sup-in-p" match="xref" use="@rid"/>
  
  <xsl:output  byte-order-mark="yes" method="html"/> 
  ...
  <xsl:text disable-output-escaping='yes'>&lt;!DOCTYPE html></xsl:text>
    <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" class="no-js no-jr">
      <head>		
		<script type="text/javascript" src="/PubReader/js/jr.boots.js"> </script>		
		
		<!-- Modify if New version was released -->
		<title><xsl:apply-templates select="(//article-title)[1]" /></title>
        ...
        <link rel="stylesheet" href="/PubReader/lib/css/normalize.css" type="text/css" />
        <link rel="stylesheet" href="/PubReader/lib/css/figpopup.css" type="text/css" />
        <link rel="stylesheet" href="/PubReader/css/jr.ui.css" type="text/css" />
        <link rel="stylesheet" href="/PubReader/css/jr.pagemanager.css" type="text/css" />
        <link rel="stylesheet" href="/PubReader/css/jr.pageturnsensor.css" type="text/css" />
        <link rel="stylesheet" href="/PubReader/css/jr.pageprogressbar.css" type="text/css" />
        <link rel="stylesheet" href="/PubReader/css/jr.objectbox.css" type="text/css" />
        <link rel="stylesheet" href="/PubReader/css/jr.panel.css" type="text/css" />
        <link rel="stylesheet" href="/PubReader/css/jr.panel.typo.css" type="text/css" />
        <link rel="stylesheet" href="/PubReader/css/jr.panel.cmap.css" type="text/css" />
        <link rel="stylesheet" href="/PubReader/css/jr.panel.istrip.css" type="text/css" />
        <link rel="stylesheet" href="/PubReader/css/jr.fip.css" type="text/css" />
        <link rel="stylesheet" href="/PubReader/css/jr.content.css" type="text/css" />
      ...
      <body>
        <div id="jr" data-jr-path="/PubReader/">
          ...
          <div id="jr-ui" class="hidden">
              ...
              <div class="flexh tb">
                <div id="jr-tb1">
                  <a id="jr-pmc-sw" href="/" class="btn link wsprkl"
                    title="PMC Home Page">
                    <img src="/PubReader/img/pub_r_home_logo.gif" alt="pmc logo" />
                  </a>
                ...
                <div class="jr-rhead f1">
                	<!-- Modify if New version was released -->
                  <div class="t"><xsl:apply-templates select="(//article-title)[1]" /></div>
                  <div class="j"><xsl:apply-templates select="/article/front/article-meta" mode="article-citation" /></div>
                </div>
                <div id="jr-tb2">
            ...
            <aside id="jr-alt-p" class="hidden flexv">
              ...
              <div class="cnt lol f1">
				<xsl:call-template name="alternative-link" />
              </div>
            </aside>
            ...
            <aside id="jr-help-p" class="hidden flexv">
              ...
              <div class="cnt f1">
                ...
                <div class="lol">
                  <a id="jr-helpobj-sw" data-path="/PubReader/" data-href="/PubReader/img/help.xml" href="">Help with
                    PubReader</a><a
                        href="mailto:pubmedcentral@ncbi.nlm.nih.gov?subject=PubReader%20feedback">Feedback /
                        suggestions</a><a id="jr-about-sw" data-path="/PubReader/" data-href="/PubReader/img/about.xml"
          ...
          <div id="jr-scripts">
            <script src="/PubReader/lib/js/jquery-1.7.2.js" type="text/javascript"> </script>
            <script src="/PubReader/lib/js/modernizr.jr.js" type="text/javascript"> </script>
            <script src="/PubReader/lib/js/jquery.throttle.js" type="text/javascript"> </script>
            <script src="/PubReader/lib/js/jquery.mousewheel.js?x=1" type="text/javascript"></script>
            <script src="/PubReader/lib/js/rangeinput.js" type="text/javascript"> </script>
            <script src="/PubReader/lib/js/jquery.touchSwipe.js" type="text/javascript"> </script>
            <script src="/PubReader/lib/js/jquery.hoverIntent.js" type="text/javascript"> </script>
            <script src="/PubReader/lib/js/figpopup.js" type="text/javascript"> </script>
            <script src="/PubReader/js/jr.utils.js" type="text/javascript"> </script>
            <script src="/PubReader/js/jquery.jr.ft.js" type="text/javascript"></script>
            <script src="/PubReader/js/jquery.jr.pagemanager.js" type="text/javascript"> </script>
            <script src="/PubReader/js/jquery.jr.paginationstatus.js" type="text/javascript"> </script>
            <script src="/PubReader/js/jquery.jr.pageturnsensor.js" type="text/javascript"> </script>
            <script src="/PubReader/js/jquery.jr.pageprogressbar.js" type="text/javascript"> </script>
            <script src="/PubReader/js/jquery.jr.links.js" type="text/javascript"> </script>
            <script src="/PubReader/js/jquery.jr.historykeeper.js" type="text/javascript"> </script>
            <script src="/PubReader/js/jquery.jr.objectbox.js" type="text/javascript"> </script>
            <script src="/PubReader/js/jquery.jr.switcher.js" type="text/javascript"> </script>
            <script src="/PubReader/js/jquery.jr.panel.js" type="text/javascript"> </script>
            <script src="/PubReader/js/jquery.jr.panel.typo.js" type="text/javascript"> </script>
            <script src="/PubReader/js/jquery.jr.panel.cmap.js" type="text/javascript"> </script>
            <script src="/PubReader/js/jquery.jr.panel.istrip.js" type="text/javascript"> </script>
            <script src="/PubReader/js/jquery.jr.fip.js" type="text/javascript"></script>
            <script src="/PubReader/js/jats.reader.js" type="text/javascript"> </script>
            ...
            <script type="text/javascript" src="/PubReader/js/ajax_ref.js"></script>
          </div>
        </div>
      </body>
    </html>
