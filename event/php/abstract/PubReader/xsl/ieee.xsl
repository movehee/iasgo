...
<xsl:stylesheet version="1.0"
  ...
  exclude-result-prefixes="xlink" default-space="strip"> 
	...
	<xsl:import href="include.tag.xsl" />
	<xsl:import href="include.func.xsl" />	
	<xsl:import href="include.date.xsl" />
	<xsl:import href="include.sup.xsl" />
	<xsl:import href="include.article-meta.xsl" />	
	<xsl:import href="include.ref_ieee.xsl" />
	<xsl:import href="include.front.xsl" />
	<xsl:import href="include.body.xsl" />
	<xsl:import href="include.back.xsl" />
	<xsl:import href="include.content.xsl" />
	<xsl:import href="include.html.xsl" />
