...
<ul class="subjectList">
	...
	$query =  "
	select * from (
		select 'A' as type, receipt_num, pt_order_info, position, author, announcer, exchange_author, gubun, subject, purpose, method, effect, conclusion, section_category, section_gubun_mobile, pt_order_info as orderby from korl_abstract_tbl_type_i a, section_info b where a.section_code=b.section_code and ifnull(pt_order_info,'')!='' and code='$abs_code'
		union
		select 'B' as type, receipt_num, pt_order_info, position, author, announcer, exchange_author, gubun, subject, purpose, method, effect, conclusion, section_category, section_gubun_mobile, concat('Z', pt_order_info) as orderby from korl_abstract_tbl_type_i_sub a, section_info2 b where a.section_code=b.section_code and ifnull(pt_order_info,'')!='' and code='$abs_code' 
	) a ";
