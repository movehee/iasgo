<?php
	...
	if($view_from == "abstract") {
		...
		$query =  "
		select * from (
			select 'A' as type, receipt_num, pt_order_info, position, author, announcer, exchange_author, gubun, subject, purpose, method, effect, conclusion, section_category from korl_abstract_tbl_type_i a, section_info b where a.section_code=b.section_code and ifnull(pt_order_info,'')!='' and code='$abs_code'
			union
			select 'B' as type, receipt_num, pt_order_info, position, author, announcer, exchange_author, gubun, subject, purpose, method, effect, conclusion, section_category from korl_abstract_tbl_type_i_sub a, section_info2 b where a.section_code=b.section_code and ifnull(pt_order_info,'')!='' and code='$abs_code' 
