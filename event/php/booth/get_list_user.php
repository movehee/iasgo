...
<style>
ul.booth span {display:none;position:absolute;left:0;top:0;width:100%;height:100%;text-indent:-10000px;background:rgba(0,0,0,.7) url('/image/booth_checked.png') center center no-repeat;background-size:62px;}
</style>
<?}else{?>
<style>
ul.booth span {display:none;position:absolute;left:0;top:0;width:100%;height:100%;text-indent:-10000px;background:rgba(0,0,0,.7) url('/image/booth_checked2.png') center center no-repeat;background-size:62px;}
</style>
<?}?>
