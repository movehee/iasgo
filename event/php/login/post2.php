...
ob_start();
setcookie('login_feedback', 'Y', time() + 60*60*24, '/', $_cookie_domain);
...
if($event_col['agendaYN']=="Y"){
	RefreshURL("./../agenda/view.php?code=".$code);
}else if($event_col['votingYN']=="Y"){
	RefreshURL("./../view.php?code=".$code);
}else if($event_col['questionYN']=="Y"){
	RefreshURL("./../question/view.php?code=".$code);
}else if($event_col['feedbackYN']=="Y"){
