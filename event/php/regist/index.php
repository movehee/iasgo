							...
							if($("input[name='necessary_"+i+"']").parents("tr").css("display") != "none"){
								if(document.getElementById("type_"+i).value=="40"){
									if($("input[name='val_"+i+"[0]']").val()==""){
										alert("필수값을 입력해주세요.");
										$("input[name='val_"+i+"[0]']").focus();
										return false;
									} else if ($("input[name='val_"+i+"[1]']").val()==""){
										alert("필수값을 입력해주세요.");
										$("input[name='val_"+i+"[1]']").focus();
										return false;
									}
									...
									if($("input[name='val_"+i+"[0]']").val()==""){
										...
										alert("필수값을 입력해주세요.");
										$("input[name='val_"+i+"[2]']").focus();
										return false;
									}
								}else if(document.getElementById("type_"+i).value=="120"){
									if($("input[name='val_"+i+"[0]']").val()==""){
										alert("필수값을 입력해주세요.");
										$("input[name='val_"+i+"[0]']").focus();
										return false;
									...
									if(document.getElementById("val_"+i).value==""){
										alert("필수값을 입력해주세요.");
										document.getElementById("val_"+i).focus();
										return false;
									}
								}
							}
