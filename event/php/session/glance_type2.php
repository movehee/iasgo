...
?>
	...
	for ($i = $min_time; $i < $max_time; $i++) {?>
		<table class="glance_time"  style="height:<?=$height+1?>px;min-height:<?=$height+1?>px;max-height:<?=$height+1?>px;font-size:<?=$session_font_size?>px;max-width:<?=$def_width-$time_width?>px;min-width:<?=$def_width-$time_width?>px;width:<?=$def_width-$time_width?>px; top: <?=($i*60-$startTime)*$height/60+$height2-1?>px; left: 0px;"><tr><td><?=$i?><br>-<br><?=$i+1?></td></tr></table>
