...
if($tab=="-1"){
	...
	if($day){
		...
		$query .= "  WHERE a.time=t.sid and a.room=r.sid and a.type = '1'  and a.code='".$code."'  and a.viewYN='Y' ";
		$query .= " and a.tab = '".$day."' ";
	...
	$query .= "  WHERE a.time=t.sid and a.room=r.sid and a.sid=b.session_sid and a.type = '1' and a.code='".$code."' and a.viewYN='Y' ";
	...
	if($search) {
		if($setting_col['faculty_type']==1){
			...
			WHERE a.code='".$code."'
			and a.type='1' and a.viewYN='Y'  and (a.theme like '%".$search."%' or a.sub_theme like '%".$search."%' or c.name like '%".$search."%' or c.name_en like '%".$search."%' or a.etc_faculty like '%".$search."%')
	...
	$query = "select a.*,t.time time_info, r.name room_info, r.viewYN room_view, r.view_type, r.photo room_photo from session_tbl a, session_room_tbl r, session_time_tbl t where a.time=t.sid and a.room=r.sid and  a.type='1' and a.code='".$code."' and a.viewYN='Y' ";
	if($category){
	...
	$query = "select a.*,t.time time_info, r.name room_info, r.viewYN room_view, r.view_type, r.photo room_photo from session_tbl a, session_room_tbl r, session_time_tbl t where a.time=t.sid and a.room=r.sid and  a.type='1' and a.code='".$code."' and a.tab='".$tab."' and a.viewYN='Y' ";
	if($room){
