...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#uploader").plupload({
			...
			url : '/script/plupload/examples/upload_poster.php?code='+code+"&file_key="+file_key+"&poster_sid="+poster_sid,
			chunk_size: '100mb',
			rename : true,
			dragdrop: true,
			// Sort files
			...
			filters : {
				...
				mime_types: [
					{title : "files", extensions : "pptx,PPTX,pdf,PDF"}
				]
			},
			views: {
				list: true,
...
<form name="myfileF" id="myfileF" method="post" action="fileupload_ppt_reg.php" enctype="multipart/form-data">
