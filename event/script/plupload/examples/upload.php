...
if (isset($_REQUEST["name"])) {
	...
	$fileName = rand(1,99999)."_".time().".".$ext;
} elseif (!empty($_FILES)) {
	$ori_filename = $_FILES["file"]["name"];
	$fileName = rand(1,99999)."_".$_FILES["file"]["name"];
} else {
...
$query = "insert into imagebank_tbl set code='$code',file_key='$file_key',filename='$ori_filename',realfile='$fileName'";
