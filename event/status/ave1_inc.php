...
<div style="width:98%;padding-top:10px;">
	<table style="width:100%;padding:0px;margin:0px;" class="ac" >
		<tr>
			...
			if($tkey!='1' && $tkey!='3' && $tkey!='5' && $tkey!='9') continue;
				?>
			<td>
				<center>
				<div style="border:2px solid #6E7C87;height:190px;width:240px;padding:30px;">
					<div style="font-size:20px;text-align:center;padding:10px;"><span style='color:red;'>[LIVE]</span> <?=$_Day['room_title'][$tkey]?></b></div>
