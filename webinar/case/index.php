...
<div class="contents">
      ...
      * Case of the Day total Commentary Book will be available to check at My Page – <a href="https://virtual.aocr2022.org/mypage/index.php?kind=down" style="color: #3f51b5;
    ...
    <p style="letter-spacing:-1px;">
       ...
       * Live Diagnosis Challenge total Commentary Book will be available to check at My Page – <a href="https://virtual.kcr4u.org/mypage/index.php?kind=down" style="color: #3f51b5;
    text-decoration: underline;">Download Center.</a>
    ...
    <ul class="quiz live">
		...
		<li <?if(${"start_day".$i}=='Y' || $day>$i){?>class="on"<?}?>>
			<a <?if(${"start_day".$i}=='Y' || $day>$i){?>href="/load/case_info.php?exam_day=<?=$i?>&category=B" class="Load_Base_R" Wsize="1105" Hsize="800" Tsize="20"<?}else{?>href="javascript:alert('This is not an ongoing event\nYou can enter from 10 minutes before.')"<?}?>>
