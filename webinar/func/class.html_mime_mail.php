...
***************************************/
		...
		if($this->de_headers == ''){
	         ...
	         $this->headers = $this->de_headers;
                ...
                if($to_name != '') $to = '"'.$this->mail_header_to_utf8($to_name).'" <'.$to_addr.'>';
                else $to = $to_addr;

                if($from_name != '') $this->from_chk = '"'.$this->mail_header_to_utf8($from_name).'" <'.$from_addr.'>';
                else $this->from_chk = $from_addr;
               ...
               # mail($to, $subject, $this->mime, $this->headers);
				#mail($to, $this->mail_header_to_utf8($subject), $this->mime, $this->headers, "-f $from_addr");
				mail($to, $this->mail_header_to_utf8($subject), $this->mime, $this->headers);
        }
