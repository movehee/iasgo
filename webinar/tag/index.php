<?php
	...
	$num = '';
	if (isset($_SERVER['REMOTE_ADDR']) && $_SERVER['REMOTE_ADDR'] == '218.235.94.220') {
		$num = '1A';
	}
?>
	...
	<div id="container">
		<div class="contents">
			...
			<div class="barcode-wrap">
				...
				<p style="margin-top:8px;font-size:14px;color:#666;">Room <?=$room?></p>
			</div>
		</div>
	</div>
</div>
<div style="position:absolute;top:0px;z-index:-111111;">
	<form id="tagF" name="tagF" action="tag_reg.php" method="post">
		...
		<input type="text" name="tag_number" id="tag_number" value="<?=htmlspecialchars($num, ENT_QUOTES, 'UTF-8')?>" style="">
	</form>
</div>
</body>
</html>
