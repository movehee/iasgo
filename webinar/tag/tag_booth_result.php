...
<?
	...
	//if($d['event_chk']!='Y'){
		//if($reject!="Y"){
			$update_query = "update registration_tbl set gubun3='29',ready_date2='".time()."' where sid='".$tag_number."'";
...
<div class="wrapper attendance">
	...
	<form id="tagF" name="tagF" action="tag_booth_reg.php" method="post" autocomplete="off" >
