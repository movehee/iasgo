...
if($time['sid']) {
	...
	if($time['stime']) {
		...
		if(strtotime("2025-05-29 08:30")>$check_in_time){
			$check_in_time = strtotime("2025-05-29 08:30");	
		}
		if($check_out_time>strtotime("2025-05-29 11:50")){
			$check_out_time = strtotime("2025-05-29 11:50");
		}
